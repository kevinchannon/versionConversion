...
[[nodiscard]] constexpr auto to_comp_2_version_with_range_lookup(Comp_1 ver) noexcept -> Comp_2 {
  ...
  return arr_lookup.end() != mapping ? static_cast<Comp_2>(static_cast<uint32_t>(mapping->second) - 1) : static_cast<Comp_2>(static_cast<uint32_t>(Comp_2::count) - 1);
}
...
[[nodiscard]] auto to_comp_2_version_with_unordered_map(Comp_1 ver) noexcept -> Comp_2 {
  ...
  return uo_map_lookup.end() != find ? find->second : static_cast<Comp_2>(static_cast<uint32_t>(Comp_2::count) - 1);
}
